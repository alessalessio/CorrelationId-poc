...
namespace Api.CorrelationId
{
    ...
    public class ClassUsingOptimisedLogging
    {
        ...
        {
            public static readonly EventId Started = new EventId(666, "Started");
        }
        ...
        private static class Log
        {
            ...
            private static readonly Action<ILogger, string, int, Exception> _informationLoggerMessageTwoParams = LoggerMessage.Define<string, int>(
                LogLevel.Information,
                Events.Started,
            ...
            public static void InformationalMessageTwoParams(ILogger logger, string value1, int value2)
                => _informationLoggerMessageTwoParams(logger, value1, value2, null);
